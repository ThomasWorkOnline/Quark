...
namespace Entropy {
    ...
    public:
        ...
        virtual void Draw(Ref<VertexArray> vertexArray, uint32_t indexCount = 0) = 0;
        virtual void DrawInstanced(Ref<VertexArray> vertexArray, uint32_t repeatCount, uint32_t indexCount = 0) = 0;
