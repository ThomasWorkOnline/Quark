...
6. For references to work properly. Make sure to set the working environment either via the `ApplicationOptions`
or move the executable to the desired working directory.
