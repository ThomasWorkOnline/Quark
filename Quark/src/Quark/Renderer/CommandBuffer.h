...
namespace Quark {
	...
	public:
		...
		virtual void BindUniformBuffer(const UniformBuffer* uniformBuffer, uint32_t binding) = 0;
		virtual void BindTexture(const Texture* texture, const Sampler* sampler, uint32_t binding, uint32_t samplerIndex = 0) = 0;
