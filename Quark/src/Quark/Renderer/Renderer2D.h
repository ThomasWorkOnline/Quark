...
namespace Quark {
	...
	public:
		...
		static void BeginScene(const Mat4f& cameraProjection, const Mat4f& cameraView = Mat4f(1.0f));
		...
		static void DrawQuad(const Vec4f& color, const Mat4f& transform = Mat4f(1.0f));
		static void DrawQuad(const Vec3f& start, const Vec3f& end, const Vec4f& color);
		...
		static void PushText(std::string_view text, const Font* font, const Vec4f& color = Vec4f(1.0f), const Mat4f& transform = Mat4f(1.0f));
		static void PushText(std::string_view text, const Font* font, const Vec4f& color = Vec4f(1.0f), const Vec3f& position = Vec3f(0.0f));

		static void DrawText(std::string_view text, const Font* font, const Vec4f& color = Vec4f(1.0f), const Mat4f& transform = Mat4f(1.0f));
		static void DrawText(std::string_view text, const Font* font, const Vec4f& color = Vec4f(1.0f), const Vec3f& position = Vec3f(0.0f));
