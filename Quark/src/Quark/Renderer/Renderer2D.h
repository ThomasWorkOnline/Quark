...
namespace Quark {
	...
	public:
		...
		static void DrawSprite(Texture* texture, float aspectRatio, const Vec4f& tint = Vec4(1.0f));
		...
		static void DrawText(std::string_view text, Font* font, const Vec4f& color = Vec4f(1.0f), const Mat4f& transform = Mat4f(1.0f));
