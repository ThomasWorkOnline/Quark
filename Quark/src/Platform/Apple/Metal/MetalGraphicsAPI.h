...
namespace Quark {
	...
	public:
		...
		virtual Scope<IndexBuffer>           CreateIndexBuffer(const uint32_t* indices, uint32_t count, IndexType indexType) final override { return nullptr; }
		virtual Scope<IndexBuffer>           CreateIndexBuffer(uint32_t count, IndexType indexType) final override { return nullptr; }
		...
		virtual Scope<Shader>                CreateShader(std::string_view name,
		                                                  ...
		                                                  std::string_view fragmentSource) final override { return nullptr; }
		...
		virtual Scope<Shader>                CreateShader(std::string_view name,
		                                                  ...
		                                                  std::span<const uint32_t> fragmentSpirv) final override { return nullptr; }
		...
		virtual Scope<UniformBuffer>         CreateUniformBuffer(size_t size) final override { return nullptr; }

		virtual const char*                  GetName() const final override { return "Metal"; }
		virtual const char*                  GetDeviceName() const final override { return ""; }
