...
#	define ENABLE_VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT
#	define ENABLE_VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT
#else
#	define ENABLE_VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT 0
#	define ENABLE_VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT 0
#endif
...
namespace Quark {
	...
	static VkDebugUtilsMessengerCreateInfoEXT CreateVkDebugUtilsMessengerCreateInfoEXT()
	{
		...
		messengerCreateInfo.messageSeverity =
			...
			| ENABLE_VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT
			| ENABLE_VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT;
