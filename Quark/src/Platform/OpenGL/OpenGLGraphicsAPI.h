...
namespace Quark {
	...
	public:
		...
		virtual Scope<Texture2D>             CreateTexture2D(std::string_view filepath, const SamplerRenderModes& renderModes = {}) final override;
		...
		virtual const char*                  GetName() const final override { return "OpenGL"; }
