...
namespace Quark {
	...
	public:
		...
		virtual uint32_t                   GetRendererFramesInFlight() const override { return 1; }
		...
		virtual Ref<FramebufferAttachment> CreateFramebufferAttachment(void* image, const FramebufferAttachmentSpecification& spec) override;
